@extends('layouts.roadinspectorLayout')
      ...
      @section('content')
        ...
        <span class="card-title"> {{ $complaint->panchayath_or_municipal }} </span>
      </div>
      			...
      			<div class="card-stacked grey-text">
                   ...
                   <a href="/roadinspector/fakecomplaint/create/{{ $complaint->id }}" class="waves-effect waves-light red btn btn-large">
                      <i class="material-icons left">assignment_late</i>
                         Fake Complaint
                   </a>

                    <a href="/roadinspector/create/{{ $complaint->id }}" class="waves-effect waves-light btn btn-large right">
