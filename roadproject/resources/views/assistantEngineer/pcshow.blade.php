      	...
      	<div class="row">
             ...
             <div class="card-image">
                ...
                <span class="card-title">Forwarded On : {{ $complaint_inspection_detail->created_at }}</span>
                  ...
                  @if($complaint_inspection_detail->damage_level == 'LEVEL 4 (Construction Of New Road Required)')
                  <a href="/assistantengineer/create/{{ $complaint_inspection_detail->id }}" class="btn btn-large blue white-text">Upload Estimation</a>
                  @else
                  <a href="/assistantengineer/lowlevel/{{ $complaint_inspection_detail->id }}" class="btn btn-large blue white-text">Upload Estimation</a>
                  @endif
                </div>
            </div>
      		</div>
