@extends('layouts.municipalLayout')
      ...
      <div class="container">
        <p class="card-panel orange-text text-darken-2 white center" style="margin-left: 200px;"><b>Ongoing Complaint:</b> <b class="grey-text text-darken-2">{{ $updation_count }}</b></p>
