...
class CreateEditestimationdetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('editestimationdetails', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('editestimationdetails');
    }
}
